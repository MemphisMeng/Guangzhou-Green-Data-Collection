...
网址/url： http://www.xinyi.gov.cn/zdly/hbhjbh/hbjsxmhjyxpjxx
备注/note：信宜市人民政府网
"""
...
class HpSpider(scrapy.Spider):
    name = 'gd_maoming_xinyishi'  
    page = 9

    url = 'http://www.xinyi.gov.cn/zdly/hbhjbh/hbjsxmhjyxpjxx_{page}'  

    basic_info = {'province': 6,
                  'city': 85,
                  'source_webname': '信宜市人民政府网',
                  'sp_bm': '茂名市信宜市环境保护局'}
    ...
    def parse_type(self, response):
        ...
        body = response.xpath('//div[@class="conTxt"]/table')
        files = None
        if title and body:
