...
网址/url： http://www.yangchun.gov.cn/xxgk/zdlyxxgk/hjbh/index.html
备注/note：阳春市人民政府门户网站
"""
...
class HpSpider(scrapy.Spider):
    name = 'gd_yangjiang_yangchunshi'  
    page = 33 

    url = 'http://www.yangchun.gov.cn/content/column/4697465?pageIndex={page}'  

    basic_info = {'province': 6,
                  'city': 91,
                  'source_webname': '阳春市人民政府门户网站',
                  'sp_bm': '阳江市阳春市环境保护局'}
    ...
    def parse_url(self, response):
        links = response.xpath('//div[@class="navjz clearfix"]//li/a')
        for link in links:
                ...
                if is_test:
                    ...
                    for i, data_row in enumerate(data_rows):
                        if i > 0:
                            ...
                            item['date_time'] = response.xpath('string(//div[@class="fl newsinfoleft"])').\
