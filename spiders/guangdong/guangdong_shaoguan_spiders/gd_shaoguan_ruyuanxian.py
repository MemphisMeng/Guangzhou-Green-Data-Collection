...
网址/url： https://zdly.sg.gov.cn/website/zdly/govPublicZdly!titletype_more.action?siteOrgCode=440232
备注/note：乳源县人民政府网
"""
...
class HpSpider(scrapy.Spider):
    name = 'gd_shaoguan_ruyuanxian'  
    page = 109 

    url = 'https://zdly.sg.gov.cn/website/zdly/govPublicZdly!titletype_more.action?siteOrgCode=440232'

    basic_info = {'province': 6,
                  'city': 90,
                  'source_webname': '乳源县人民政府网',
                  'sp_bm': '韶关市乳源县环境保护局'}
