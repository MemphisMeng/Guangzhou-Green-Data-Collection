...
网址/url： https://zdly.sg.gov.cn/website/zdly/govPublicZdly!titletype_more.action?typecode=56&css=hjbh&siteOrgCode=440224
备注/note：仁化县人民政府网
"""
...
class HpSpider(scrapy.Spider):
    name = 'gd_shaoguan_renhuaxian'  
    page = 36 

    url = 'https://zdly.sg.gov.cn/website/zdly/govPublicZdly!titletype_more.action?siteOrgCode=440224'

    basic_info = {'province': 6,
                  'city': 90,
                  'source_webname': '仁化县人民政府网',
                  'sp_bm': '韶关市仁化县环境保护局'}
