...
网址/url： http://www.xinxing.gov.cn/web/xxmh/channel/channel_zdly.ptl?channelCode=125007009003
备注/note：新兴县人民政府门户网站
"""
...
class HpSpider(scrapy.Spider):
    name = 'gd_yunfu_xinxingxian'
    page = 8 

    url = 'http://www.xinxing.gov.cn/web/xxmh/channel/channel_zdly.ptl?channelCode=125007009003&pageNo={page}'  

    basic_info = {'province': 6,
                  'city': 92,
                  'source_webname': '新兴县人民政府门户网站',
                  'sp_bm': '云浮市新兴县环境保护局'}
    ...
    def parse_url_sl(self, response):
        trs = response.xpath('//div[@class="Section1"]//td[5]/..')
        if trs:
                    ...
                    for i, data_row in enumerate(data_rows):
                        if i > 0:
                            ...
                            if file_texts:
                                ...
                                file_texts = response.xpath('//div[@class="Section1"]//a[contains(@href, "/")'
