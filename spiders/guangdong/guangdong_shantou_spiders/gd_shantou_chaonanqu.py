...
网址/url： http://zwgk.shantou.gov.cn/cnhbj/zwgk/cnzwgk.shtml?catecode=gkzn
备注/note：潮南区人民政府网
"""
...
class HpSpider(scrapy.Spider):
    name = 'gd_shantou_chaonanqu'  
    # page = 1

    url = 'http://zwgk.shantou.gov.cn/cnhbj/0801/cnright.shtml'  

    basic_info = {'province': 6,
                  'city': 88,
                  'source_webname': '潮南区人民政府网',
                  'sp_bm': '汕头市潮南区环境保护局'}
