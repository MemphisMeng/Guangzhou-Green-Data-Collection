...
网址/url： http://zwgk.shantou.gov.cn/cyzdly/800703/list.shtml
备注/note：潮阳区人民政府网站
"""
...
class HpSpider(scrapy.Spider):
    name = 'gd_shantou_chaoyangqu'  
    page = 2 

    url = 'http://zwgk.shantou.gov.cn/cyzdly/800703/list_{page}.shtml'  

    basic_info = {'province': 6,
                  'city': 88,
                  'source_webname': '潮阳区人民政府网站',
                  'sp_bm': '汕头市潮阳区环境保护局'}
    ...
    def start_requests(self):
        yield scrapy.Request(url='http://zwgk.shantou.gov.cn/cyzdly/800703/list.shtml', callback=self.parse_url)
