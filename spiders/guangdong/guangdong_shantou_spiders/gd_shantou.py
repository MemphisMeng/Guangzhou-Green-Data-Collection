...
网址/url： http://zwgk.shantou.gov.cn/stzdly/ybjsslgs/list.shtml
备注/note：汕头市人民政府网
"""
...
class HpSpider(scrapy.Spider):
    ...
    url = 'http://zwgk.shantou.gov.cn/stzdly/ybjsslgs/list_{page}.shtml'  

    basic_info = {'province': 6,
                  'city': 88,
                  'source_webname': '汕头市人民政府网',
                  'sp_bm': '汕头市环境保护局'}
    ...
    def start_requests(self):
        yield scrapy.Request(url='http://zwgk.shantou.gov.cn/stzdly/ybjsslgs/list.shtml', callback=self.parse_url)
