...
网址/url： http://zwgk.longmen.gov.cn/5019/lmList.shtml
备注/note：龙门县人民政府门户网站
"""
...
class HpSpider(scrapy.Spider):
    name = 'gd_huizhou_longmenxian'  
    page = 7

    url = 'http://zwgk.longmen.gov.cn/lmzdly/jsxmhp/hb_list_{page}.shtml'  

    basic_info = {'province': 6,
                  'city': 82,
                  'source_webname': '龙门县人民政府门户网站',
                  'sp_bm': '惠州市龙门县生态环境局'}
    ...
    def start_requests(self):
        yield scrapy.Request(url='http://zwgk.longmen.gov.cn/lmzdly/jsxmhp/hb_list.shtml', callback=self.parse_url)
