...
网址/url： http://www.puning.gov.cn/bumen/pnhbj/6?pageNum=1&pageSize=15
备注/note：普宁市人民政府门户网站
"""
...
class HpSpider(scrapy.Spider):
    name = 'gd_jieyang_puningshi'  
    page = 7

    url = 'http://www.puning.gov.cn/bumen/pnhbj/6?pageNum={page}&pageSize=15'  

    basic_info = {'province': 6,
                  'city': 83,
                  'source_webname': '普宁市人民政府门户网站',
                  'sp_bm': '揭阳市普宁市环境保护局'}
