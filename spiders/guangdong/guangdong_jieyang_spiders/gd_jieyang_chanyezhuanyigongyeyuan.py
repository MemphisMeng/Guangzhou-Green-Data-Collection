...
网址/url： http://zwgk.jycyy.gov.cn/openInfo.action?depCode=799323344
备注/note：揭阳产业转移工业园政府信息公开目录系统
"""
...
class HpSpider(scrapy.Spider):
    name = 'gd_jieyang_chanyezhuanyigongyeyuan'  
    page = 35

    url = 'http://zwgk.jycyy.gov.cn/OpenInfoRight.action?pageNum={page}&pageSize=10&depCode=799323344&menuCat=481'

    basic_info = {'province': 6,
                  'city': 84,
                  'source_webname': '揭阳产业转移工业园政府信息公开目录系统',
                  'sp_bm': '揭阳产业转移工业园环境保护和安全生产监督局'}
