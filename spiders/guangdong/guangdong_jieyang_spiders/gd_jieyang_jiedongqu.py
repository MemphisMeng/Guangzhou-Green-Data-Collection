...
网址/url： http://www.jiedong.gov.cn/zdly_jd/cataList?deptId=43&catalogueId=465
备注/note：揭阳市揭东区环境保护局
"""
...
class HpSpider(scrapy.Spider):
    name = 'gd_jieyang_jiedongqu'  
    page = 66

    url = 'http://www.jiedong.gov.cn/zdly_jd/cataList?deptId=43&catalogueId=465&pageNum={page}&pageSize=15'  

    basic_info = {'province': 6,
                  'city': 83,
                  'source_webname': '揭阳市揭东区环境保护局',
                  'sp_bm': '揭阳市揭东区环境保护局'}
    ...
    def parse_url(self, response):
        links = response.xpath('//div[@class="listtable"]//li/span[@class="s1"]/a')
        for link in links:
