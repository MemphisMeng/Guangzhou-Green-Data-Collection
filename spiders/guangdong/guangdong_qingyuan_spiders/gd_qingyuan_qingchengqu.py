...
网址/url： http://www.qingcheng.gov.cn/channel/129005003/?dc=null
备注/note：清城区重点领域信息公开专栏
"""
...
class HpSpider(scrapy.Spider):
    name = 'gd_qingyuan_qingchengqu'  
    page = 17

    url = 'http://www.qingcheng.gov.cn/channel/129005003/?dc=null&pageNo={page}&$$time$$=20190604120122'  

    basic_info = {'province': 6,
                  'city': 87,
                  'source_webname': '清城区重点领域信息公开专栏',
                  'sp_bm': '清远市清城区环境保护局'}
    ...
    def parse_type(self, response):
        ...
        body = response.xpath('//div[@class="article"]/div/table')
        files = None
        if title and body and '验收' not in title and '登记表' not in title:
