...
网址/url： http://www.xingning.gov.cn/content/channel/53b13016eabc88deb1746097/
备注/note：兴宁市人民政府网
"""
...
class HpSpider(scrapy.Spider):
    name = 'gd_meizhou_xingningshi'  
    page = 25

    url = 'http://www.xingning.gov.cn/content/channel/53b13016eabc88deb1746097/page-{page}/'  

    basic_info = {'province': 6,
                  'city': 86,
                  'source_webname': '兴宁市人民政府网',
                  'sp_bm': '梅州市兴宁市环境保护局'}
    ...
    def parse_url(self, response):
        links = response.xpath('//div[@class="listright_box"]//li/a')
        for link in links:
    ...
    def parse_type(self, response):
        title = response.xpath('string(//h1[@class="detail_ltitle"])').extract_first(default='')
