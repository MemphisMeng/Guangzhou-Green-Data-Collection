...
网址/url： http://203.91.36.18/lgqymh/pages/ebcm/business/web/wryxxgk/index.jsp
备注/note：龙岗区水务系统
"""
...
class HpSpider(scrapy.Spider):
    name = 'gd_shenzhen_longgangqu'

    sl_page = 605
    sl_url = 'http://203.91.36.18/lgqymh/pages/ebcm/business/web/wryxxgk/xmsp/more.jsp?TYPE=sp_sl'

    nsp_page = 610
    nsp_url = 'http://203.91.36.18/lgqymh/pages/ebcm/business/web/wryxxgk/xmsp/more.jsp?TYPE=sp_spq'

    sp_page = 354
    sp_url = 'http://203.91.36.18/lgqymh/pages/ebcm/business/web/wryxxgk/xmsp/more.jsp?TYPE=sp_sph'

    basic_info = {'province': 6,
                  'city': 77,
                  'source_webname': '龙岗区水务系统',
                  'sp_bm': '深圳市龙岗区环境保护和水务局'}
    ...
    def parse_url(self, response):
        links = response.xpath('//div[@class="hpgs_line padding_1"]//li/a')
        for link in links:
    ...
    def parse_type(self, response):
        ...
        body = response.xpath('//table[@class="table1"]')
        files = None
        if title and body:
