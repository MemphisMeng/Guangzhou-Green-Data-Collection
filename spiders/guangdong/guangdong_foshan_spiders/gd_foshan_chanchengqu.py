...
网址/url： http://www.chancheng.gov.cn/chancheng/hjxx03/cclist.shtml
备注/note：禅城区人民政府门户网
"""
...
class HpSpider(scrapy.Spider):
    name = 'gd_foshan_chanchengqu'  
    page = 50

    url = 'http://www.chancheng.gov.cn/chancheng/hjxx03/cclist_{page}.shtml'  
    ...
    def parse_type(self, response):
        ...
        body = response.xpath('//div[@id="zoomcon"]//table//table')
        files = None
        if title and body:
