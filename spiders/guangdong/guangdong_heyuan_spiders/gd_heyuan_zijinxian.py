...
网址/url： http://www.zijin.gov.cn/content/column/4697567?pageIndex=1
备注/note：紫金县人民政府门户网站
"""
...
class HpSpider(scrapy.Spider):
    name = 'gd_heyuan_zijinxian'  
    page = 15

    url = 'http://www.zijin.gov.cn/content/column/4697567?pageIndex={page}'  

    basic_info = {'province': 6,
                  'city': 81,
                  'source_webname': '紫金县人民政府门户网站',
                  'sp_bm': '河源市紫金县环境保护局'}
    ...
    def parse_url(self, response):
        links = response.xpath('//div[@class="navjz"]//li/a')
        for link in links:
