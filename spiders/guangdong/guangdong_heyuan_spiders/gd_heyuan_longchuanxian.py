...
日期/date：2019/3/25
修改者/modifier：
修改日期/update date：2019、/530

网址/url： http://www.longchuan.gov.cn/content/column/4341314?pageIndex=1
备注/note：广东龙川政府门户网站
"""
...
class HpSpider(scrapy.Spider):
    name = 'gd_heyuan_longchuanxian'  
    page = 14

    url = 'http://www.longchuan.gov.cn/content/column/4341314?pageIndex={page}'  

    basic_info = {'province': 6,
                  'city': 81,
                  'source_webname': '广东龙川政府门户网站',
                  'sp_bm': '河源市龙川县环境保护局'}
    ...
    def parse_url(self, response):
        links = response.xpath('//div[@class="listnews"]//li/a')
        for link in links:
