...
网址/url： http://www.ahtlyaq.gov.cn/opennessContent/?branch_id=5a065695dd615fabd37256cf&column_code=190100
备注/note：铜陵市义安区人民政府网
"""
...
class HpSpider(scrapy.Spider):
    name = 'ah_tongling_yianqu'  
    page = 28

    url = 'http://www.ahtlyaq.gov.cn/opennessTarget/?branch_id=5a065695dd615fabd37256cf&column_code=190105&page={page}'  

    basic_info = {'province': 3,
                  'city': 48,
                  'source_webname': '铜陵市义安区人民政府网',
                  'sp_bm': '铜陵市义安区环境保护局'}
    ...
    def parse_url(self, response):
        ...
        for link in links:
            date_time = link.xpath('string(./../../../td[3])').re_first('\d{4}\D\d{1,2}\D\d{1,2}')
    ...
    def parse_type(self, response):
        title = response.xpath('string(//h1[@class="content-title"])').extract_first(default='')
